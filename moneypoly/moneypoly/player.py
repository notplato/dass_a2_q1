...
class Player:
    ...
    def move(self, steps):
        ...
        if self.position < prev_pos or self.position == 0 :
            self.add_money(GO_SALARY)
            print(f"  {self.name} landed/passed on Go and collected ${GO_SALARY}.")
    ...
    def go_to_jail(self):
        ...
        self.jail_props["in_jail"] = True
        self.jail_props["jail_turns"] = 0
    ...
    def status_line(self):
        ...
        jail_tag = " [JAILED]" if self.jail_props["in_jail"] else ""
        return (
